...
void descKeypoints(vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat &descriptors, double &time, string descriptorType)
{
...
void detKeypointsModern(vector<cv::KeyPoint> &keypoints, cv::Mat &img, double &time, string detectorType, bool bVis)
{
